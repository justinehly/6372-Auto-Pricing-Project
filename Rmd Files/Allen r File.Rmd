...
setwd("/Users/allenmiller/Documents/GitHub/6372-Auto-Pricing-Project/DataSets")
...
test_lm <- lm(MSRP~Engine.Fuel.Type, data=autos)
summary(test_lm)
...
reg.fwd <- regsubsets(MSRP ~ Make,data=train, method="forward")
